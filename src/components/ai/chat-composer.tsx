      ...
      {attachments.length > 0 ? (
        <div className="mb-2 flex flex-wrap items-center gap-2">
          {attachments.map((attachment) => (
            <div
              key={attachment.id}
              className="group relative flex items-center gap-2 rounded-xl border border-stone-200/80 bg-muted/40 py-1 pe-8 ps-1.5 dark:border-stone-700/60"
            >
              {attachment.kind === "image" ? (
                ...
                <span className="grid size-9 place-items-center rounded-lg bg-red-50 text-red-600 ring-1 ring-red-200/70 dark:bg-red-950/40 dark:text-red-400 dark:ring-red-900/50">
        ...
        <div className="flex items-center gap-1 pt-1">
            ...
            <>
              ...
              <DropdownMenu>
                ...
                >
                  ...
                  >
                    <span className="grid size-8 place-items-center rounded-lg bg-emerald-50 text-emerald-600 dark:bg-emerald-950/40">
                  ...
                  <DropdownMenuItem
                    ...
                    className="flex cursor-pointer items-center gap-2.5 rounded-lg px-2 py-2"
                  >
                    <span className="grid size-8 place-items-center rounded-lg bg-red-50 text-red-600 dark:bg-red-950/40">
                      <FileTextIcon className="size-4" />
                    </span>
                    <span>
                      <span className="block text-xs font-semibold">
          ...
          <Button
            ...
            className={cn(
              ...
              !busy && input.trim() && "shadow-md shadow-primary/30",
            )}
          >
