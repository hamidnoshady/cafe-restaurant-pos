...
export const SYNC_EVENT_REGISTRY = [
  ...
  { type: "inventory.purchase.created", schemaVersion: 1, handler: "inventory.purchase.created", permission: INVENTORY_PERMISSION, effectClass: "inventory", locationRule: "event_location", dependencyErrors: ["supplier_not_found", "item_not_found"], payloadFields: ["supplierId", "note", "purchaseDate", "items"] },
  ...
  { type: "inventory.transfer.created", schemaVersion: 1, handler: "inventory.transfer.created", permission: INVENTORY_PERMISSION, effectClass: "transfer", locationRule: "business_transfer", dependencyErrors: ["transfer_inventory_item_not_found", "transfer_location_not_found"], payloadFields: ["destinationLocationId", "note", "lines"] },
  ...
  { type: "inventory.stock_count.recorded", schemaVersion: 1, handler: "inventory.stock_count.recorded", permission: INVENTORY_PERMISSION, effectClass: "inventory", locationRule: "event_location", dependencyErrors: ["item_not_found"], payloadFields: ["note", "lines"] },
  ...
  { type: "inventory.production.recorded", schemaVersion: 1, handler: "inventory.production.recorded", permission: INVENTORY_PERMISSION, effectClass: "inventory", locationRule: "event_location", dependencyErrors: ["formula_not_found", "formula_inactive"], payloadFields: ["formulaId", "batches", "outputQuantity", "conversionCostRial", "note"] },
