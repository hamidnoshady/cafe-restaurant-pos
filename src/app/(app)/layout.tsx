 ...
 * `/dashboard` (now the only page left under that prefix). Nothing is
 * rewritten: the address bar, the server's route resolution and the client
 * router all agree on the same pathname, which is what the previous
 * middleware rewrite could not guarantee.
 */
