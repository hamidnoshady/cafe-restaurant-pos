        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex w-full flex-wrap items-center gap-2 sm:w-auto">
            <button
              ...
              disabled={loading}
              className="inline-flex min-h-10 flex-1 items-center justify-center gap-1.5 rounded-lg border border-border px-3 text-xs font-semibold text-stone-600 transition-colors hover:bg-muted disabled:pointer-events-none disabled:opacity-50 dark:text-stone-300 sm:flex-none"
            >
                ...
                <table className="w-full min-w-[900px] text-sm">
                  <thead>
                    <tr className="border-b border-border bg-stone-50 dark:bg-stone-500/10">
                      <th className="py-3 pe-3 ps-4 text-start text-xs font-medium text-stone-500 dark:text-stone-400">#</th>
                      <th className="py-3 pe-3 text-start text-xs font-medium text-stone-500 dark:text-stone-400">شماره فاکتور</th>
                      <th className="py-3 pe-3 text-start text-xs font-medium text-stone-500 dark:text-stone-400">مشتری</th>
                      <th className="py-3 pe-3 text-start text-xs font-medium text-stone-500 dark:text-stone-400">اقلام</th>
                      <th className="py-3 pe-3 text-start text-xs font-medium text-stone-500 dark:text-stone-400">وضعیت</th>
                      <th className="py-3 pe-3 text-start text-xs font-medium text-stone-500 dark:text-stone-400">روش پرداخت</th>
                      <th className="py-3 pe-3 text-start text-xs font-medium text-stone-500 dark:text-stone-400">مبلغ</th>
                      <th className="py-3 pe-3 text-start text-xs font-medium text-stone-500 dark:text-stone-400">تاریخ ثبت</th>
                      <th className="py-3 pe-4 text-start text-xs font-medium text-stone-500 dark:text-stone-400">عملیات</th>
                    </tr>
                  </thead>
                  <tbody>
                    {rows.map((row, index) => (
                      <tr key={row.id} className="border-b border-border transition-colors last:border-b-0 hover:bg-stone-50/70 dark:hover:bg-stone-500/10">
              ...
              <div className="mt-4 flex flex-col gap-3 border-t border-border pt-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
                ...
                <div className="flex w-full items-center gap-2 sm:w-auto">
                  <button
                    ...
                    className="inline-flex min-h-10 flex-1 items-center justify-center rounded-lg border border-border px-3 text-xs font-semibold text-stone-600 transition-colors hover:bg-muted disabled:pointer-events-none disabled:opacity-50 dark:text-stone-300 sm:flex-none"
                  >
                    قبلی
                  </button>
                  <button
