  ...
  return (
    <div className="mx-auto w-full max-w-[1600px]">
      <header className="mb-5 border-b border-stone-200/80 pb-5 sm:mb-6 sm:pb-6">
        <h1 className="text-2xl font-bold tracking-tight text-stone-950 sm:text-[1.7rem]">بدلیجات</h1>
        <p className="mt-2 max-w-3xl text-sm leading-6 text-muted-foreground">
          خانواده‌های کالا و تنوع‌های آن‌ها (رنگ، سایز، …)، موجودی و قیمت هر تنوع، و فروش.
        </p>
      </header>
      <AccessoriesManager />
    </div>
