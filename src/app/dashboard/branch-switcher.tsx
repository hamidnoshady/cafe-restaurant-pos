...
export function BranchSwitcher({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <div className={compact ? "" : "mb-3"}>
      ...
      <SearchableSelect
        className={compact ? "min-h-11 max-w-40 rounded-xl border border-stone-200/80 bg-card px-3 text-sm text-stone-950 outline-none focus-visible:ring-2 focus-visible:ring-amber-500/45" : "w-full rounded-md border bg-background px-2 py-1.5 text-sm"}
