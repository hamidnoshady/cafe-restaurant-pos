            ...
            <table className="w-full min-w-[760px] text-sm">
              <thead>
                <tr className="border-b border-border bg-muted/60">
                  ...
                  <th className="px-4 py-3 text-start text-xs font-medium text-muted-foreground sm:text-sm">نوع</th>
                  <th className="px-4 py-3 text-start text-xs font-medium text-muted-foreground sm:text-sm">انبار</th>
                  <th className="px-4 py-3 text-start text-xs font-medium text-muted-foreground sm:text-sm">طرف‌حساب</th>
                  <th className="px-4 py-3 text-start text-xs font-medium text-muted-foreground sm:text-sm">اقلام</th>
                  <th className="px-4 py-3 text-start text-xs font-medium text-muted-foreground sm:text-sm">مبلغ</th>
            ...
            <div className="space-y-4">
              ...
              <div className="overflow-x-auto rounded-xl border border-border/80">
                <table className="w-full min-w-[480px] text-sm">
                  <thead>
                    <tr className="border-b border-border bg-muted/60">
                      <th className="px-3 py-2.5 text-start text-xs font-medium text-muted-foreground">قلم</th>
                      <th className="px-3 py-2.5 text-start text-xs font-medium text-muted-foreground">مقدار</th>
                      <th className="px-3 py-2.5 text-start text-xs font-medium text-muted-foreground">قیمت واحد</th>
                  ...
                  <tfoot>
                    <tr className="bg-muted/60">
                      <td colSpan={3} className="px-3 py-2.5 text-xs font-semibold text-muted-foreground">
                        جمع کل
                      </td>
