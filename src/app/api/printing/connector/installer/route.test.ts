...
describe("GET /api/printing/connector/installer", () => {
  it("downloads a private installer pinned to the browser-facing tenant origin", async () => {
    const request = new NextRequest("http://internal:3000/api/printing/connector/installer", {
      headers: {
        host: "internal:3000",
    ...
    expect(body).toContain("https://internal:3000/windows/cafe-pos-print-connector.ps1");
  });
