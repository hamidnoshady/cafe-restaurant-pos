...
| 22 | Phase-22-Accounting-Standards-Compliance-Gap-Analysis.md | Waves 1-5 complete (Wave 4 first slice) — audit/gap-analysis, account hierarchy levels/nature/contra metadata, a terminology standards audit, revenue split by sales channel + a platform-commission expense account, a per-account دفتر معین/گردش حساب statement, and a fixed-asset register with straight-line depreciation, against GitHub issue #160 |
