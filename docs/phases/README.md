...
| 21 | Phase-21-Multi-Industry-Accounting-Platform.md | Wave 1 complete; Waves 2-4 in progress — weight/price infra, jewelry COA, gold pricing/sale posting, stone cost add-ons, and consignment sale posting shipped (service-layer only, no UI yet) |
