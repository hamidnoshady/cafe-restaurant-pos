...
| 21 | Phase-21-Multi-Industry-Accounting-Platform.md | Waves 1-4 complete — weight/price infra, jewelry COA, gold pricing/sale posting, stone cost add-ons, and consignment sale posting, now reachable through `/api/jewelry/*` routes and the `/dashboard/jewelry` page (industry-gated, not yet selectable from the setup wizard) |
